...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   DWORD dwStryle = WS_OVERLAPPED | WS_CAPTION | WS_MINIMIZEBOX | WS_SYSMENU | WS_BORDER;
   AdjustWindowRect(&rc, dwStryle, FALSE);
   HWND hWnd = CreateWindowW(szWindowClass, szTitle, dwStryle, CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, NULL, NULL, hInstance, NULL);
